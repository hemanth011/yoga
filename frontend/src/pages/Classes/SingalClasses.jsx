        ...
        <div className="container">
          ...
          <div className="lg:col-span-8 col-span-12">
              <div className="single-course-details">
                ...
                <h2 className="text-2xl mb-2">{course.
name}</h2>
                  ...
                  <div className="flex space-x-4 items-center group">
                    <div className="flex-none">
                      <div className="h-12 w-12 rounded">
                        <img
                          src={"https://plus.unsplash.com/premium_photo-1682096118912-c90b30e0f822?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
                          alt=""
...
//   console.log(course); // Check the fetched data in the console
